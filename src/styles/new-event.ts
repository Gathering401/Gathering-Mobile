...
export const styles = StyleSheet.create({
    ...
    footer: { flexDirection: 'row', gap: 12, paddingHorizontal: 16, paddingTop: 16, borderTopWidth: 1, borderTopColor: '#E5DED4', backgroundColor: '#FAF7F2' },
    ...
    submitButtonDisabled: { backgroundColor: colors.terracotta.secondary, opacity: 0.5 },
